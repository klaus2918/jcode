pub(super) use jcode_provider_openai::websocket_health::{
    ...
    WEBSOCKET_MODEL_COOLDOWN_MAX_SECS, classify_websocket_fallback_reason,
    is_stream_activity_event, is_structured_response_event, is_websocket_activity_payload,
