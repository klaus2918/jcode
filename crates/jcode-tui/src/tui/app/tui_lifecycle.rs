...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            pending_local_model_switch: None,
            ...
            background_finish_notices: Vec::new(),
            announced_finish_ids: std::collections::HashSet::new(),
            known_finish_ids: std::collections::HashSet::new(),
            last_finish_scan_at: None,
