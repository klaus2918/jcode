...
//
// The composer has always been selectable; the transcript, the part a user
// actually wants to quote, was inert. These drive the real pointer handlers
// over a real conversation, so the wiring (hit-test -> selection -> clipboard)
// is covered rather than just the geometry module.
